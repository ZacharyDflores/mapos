    ...
    <div class="span12" style="margin-left: 0">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content">
                ...
                <div class="span4">
                    <label>Usuario a editar permisos:</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir Cliente</span>
                                        </label>
                                    </td>
...
<!--
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir Producto</span>
                                        </label>
                                    </td>
...
-->
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir Servicio</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir O.S</span>
                                        </label>
                                    </td>
                 ...
                 <!--                   <td>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir Venta</span>
                                        </label>
                                    </td>
...
-->
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Visualizar Archivo</span>
                                        </label>
                                    </td>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir Archivo</span>
                                        </label>
                                    </td>
...
<!--
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Visualizar Lanzamiento</span>
                                        </label>
                                    </td>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Añadir Lanzamiento</span>
                                        </label>
                                    </td>
...
-->
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Informe O.S</span>
                                        </label>
                                    </td>
<!--
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Informe Productos</span>
                                        </label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Informe Ventas</span> 
                                        </label>
                                    </td>
 -->
                                    <td>
...
<script type="text/javascript">
    ...
    $("#formPermissao").validate({
        ...
        messages:{
            nome: {required: 'Campo obligatorio'}
        }
    });     
