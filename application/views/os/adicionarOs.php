                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <div class="span12 alert alert-danger" id="divInfo" style="padding: 1%;">Datos incompletos, comprobar los campos con asterisco o cliente correctamente seleccionado y responsable.</div>
                                <?php } ?>
  ...
  <div class="modal-body">
    <div class="widget-content nopadding">
                <?php if ($custom_error != '') {
                    ...
                    <div class="control-group">
                        <label for="documento" class="control-label">Cedula/DNI<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="rua" class="control-label">Dirección</label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label">
                        <label for="estado" class="control-label">País</label>
                        <div class="controls">
